...
static RANGES: &[(&str, u32, u32)] = &[
    ...
    ("Johnston accidentals (U+E2B0–U+E2BF)", 0xE2B0, 0xE2BF),
    ...
    ("Shakers and rattles pictograms (U+E740–U+E74F)", 0xE740, 0xE74F),
    ...
    ("Medieval/Renaissance oblique forms (U+E970–U+E98F)", 0xE970, 0xE98F),
    ...
    ("Function theory supplement (U+ED00–U+ED0F)", 0xED00, 0xED0F),
